...
export const selectCampers = (state) => state.catalog.visibleItems;
export const selectAllCampers = (state) => state.catalog.items; 
export const selectIsLoading = (state) => state.catalog.loading; 
export const selectActiveFilters = (state) => state.catalog.activeFilters;
